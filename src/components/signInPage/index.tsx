...
const SignInPage = () => {
  ...
  const { signInWithGooglePopup, createUserDocumentFromAuth, signIn, setToken, setUser } = useAuth()
  ...
  const googleSignInWithPopUp = async () => {
    ...
    if (user) {
      toast.success(`user has successfully signed in`, { autoClose: 2000 })
    ...
    try {
      ...
      switch (error.code) {
        case 'auth/wrong-password':
          toast.error(`Incorrect password for the email provided`, { autoClose: 2000 })
          break
        ...
        default:
          ...
          toast.error('An error occurred during sign-in. Please try again later.', { autoClose: 2000 })
      }
    }
  }
