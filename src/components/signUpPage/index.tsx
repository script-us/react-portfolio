...
const SignUpPage: React.FC = () => {
  ...
  const { signInWithGooglePopup, register, createUserDocumentFromAuth, setToken, setUser } = useAuth()
  ...
  const validationSchema = Yup.object().shape({
    displayName: Yup.string().required('Please enter the name'),
    email: Yup.string().email('Please enter valid email !').required('Please provide your Email Id'),
  ...
  const handleSubmit = async (values: InitialValues) => {
    ...
    try {
      const response: any = await register(values.email, values.password)
      ...
      if (error.code === 'auth/email-already-in-use') {
        toast.error('Cannot create user, email already in use', { autoClose: 2000 })
      } else {
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg ${formik.touched.displayName && formik.errors.displayName ? 'border-2 border-[#d32f2f] dark:border-[#d32f2f]' : 'border border-stroke'} bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary`}
                      name="displayName"
                    ...
                    {formik.touched.displayName && formik.errors.displayName && (
                      <p className="text-[#d32f2f] font-bold mt-[3px] mr-[14px] mb-0 ml-[14px] text-[0.75rem] leading-[1.66] tracking-[0.03333em]">
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg ${formik.touched.email && formik.errors.email ? 'border-2 border-[#d32f2f] dark:border-[#d32f2f]' : 'border border-stroke'} bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary`}
                      name="email"
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg  ${formik.touched.password && formik.errors.password ? 'border-2 border-[#d32f2f] dark:border-[#d32f2f]' : 'border border-stroke'} bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary`}
                      name="password"
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg ${formik.touched.confirmPassword && formik.errors.confirmPassword ? 'border-2 border-[#d32f2f] dark:border-[#d32f2f]' : 'border border-stroke'} bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary`}
