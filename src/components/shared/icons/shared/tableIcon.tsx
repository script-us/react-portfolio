...
const TableIcon: React.FC<ITableIconProps> = React.forwardRef<any, ITableIconProps>((props, ref): ReactElement => {
  return (
    <svg
    ...
    >
      ...
      <defs>
        <clipPath id="clip0_130_9756">
          <rect width="18" height="18" transform="translate(0 0.052124)" />
        </clipPath>
      </defs>
    </svg>
  )
